...
if (getAuthenticationFlag())
	if ($pageid == 'sendfiles')
		$local_cssvars .= str_repeat(chr(9), 3) . '#_editableareafld_0 { width:700px; height:20px; }' . chr(10) . 
					  	  str_repeat(chr(9), 3) . '#_editableareafld_1 { width:300px; height:500px; }' . chr(10) .
					  	  str_repeat(chr(9), 3) . '#_editableareafld_2 { width:500px; height:300px; }' . chr(10);
	else
		$local_cssvars .= str_repeat(chr(9), 3) . '#_editableareafld_0 { width:700px; height:20px; }' . chr(10) . 
					  	  str_repeat(chr(9), 3) . '#_editableareafld_1 { width:900px; height:500px; }' . chr(10);
...
if (getAuthenticationFlag())
	if ($pageid == 'sendfiles')
		$local_jsvars .= str_repeat(chr(9), 3) . 'var editableareas_idlist = \'' . fn_makeid('editablepagetitle') . ',' . fn_makeid('eacontent') . ',' . fn_makeid('eacontent2') . '\';' . chr(10);
	else
			...
			<div id="innerwrappercenter">
				...
				<div id="expandablelayer" align="left">
					<table width="900" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<?php if ($pageid == 'sendfiles') { ?>
								<td align="left" valign="top" class="supercopy" id="<?php echo(fn_makeid('eacontent')); ?>" style="width:300px;height:500px;padding-bottom:50px;"><?php echo(lclCUSTOM_fetchC('eacontent')); ?></td>
								<td align="left" valign="top" class="copy" style="width:550px;padding-left:50px;padding-bottom:50px;">
									<?php include('sendfilesform.php'); ?>
									<br /><br /><br />
									<span id="<?php echo(fn_makeid('eacontent2')); ?>" class="supercopy"><?php echo(lclCUSTOM_fetchC('eacontent2')); ?></span>
								</td>
							<?php } else { ?>
							<td align="left" valign="top" class="supercopy" id="<?php echo(fn_makeid('eacontent')); ?>" style="width:900px;height:500px;padding-bottom:50px;"><?php echo(lclCUSTOM_fetchC('eacontent')); ?></td>
							<?php } ?>
						</tr>
					</table>
					<div id="innerfooter">
