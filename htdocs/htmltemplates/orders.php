...
if (getAuthenticationFlag())
	$local_cssvars .= str_repeat(chr(9), 3) . '#_editableareafld_0 { width:700px; height:20px; }' . chr(10) . 
				  	  str_repeat(chr(9), 3) . '#_editableareafld_1 { width:900px; height:100px; }' . chr(10);
...
$local_jslibcalls .= '<script type="text/javascript" src="events.php?event=getdata"></script>' . chr(10) .
					 str_repeat(chr(9), 2) . '<script type="text/javascript" src="lib.js"></script>' . chr(10) .
					 str_repeat(chr(9), 2) . '<script type="text/javascript">' . 'getMaterials();' . '</script>'. chr(10);
			...
			<div id="innerwrappercenter">
				<div style="position:relative;width:960px;height:63px;background-image:url(/images/bkg-orange.jpg);">
					<div style="position:absolute;top:0px;left:0px;width:215px;height:61px;">
						<div class="top_left" style="position:relative;width:215px;height:61px;">
							<div style="position:absolute;top:15px;left:1px;width:210px;height:34px;"><a href="/" title="Home Page"><img src="/images/logo-bigbanners.jpg" alt="" width="210" height="34" border="0" /></a></div>
						</div>
					</div>
					<div style="position:absolute;top:0px;left:217px;width:744px;height:61px;">
						<div style="position:relative;width:744px;height:61px;background-image:url(/images/bkg-stripe.jpg);">
							<div style="position:absolute;top:23px;left:0px;width:735px;height:20px;"><?php include('topmenunav.php'); ?></div>
						</div>
					</div>
				</div>
				...
				<div id="expandablelayer" align="left">
					<table width="900" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td align="left" valign="top" class="supercopy" id="<?php echo(fn_makeid('eacontent')); ?>" style="width:900px;height:50px;padding-bottom:20px;padding-top:10px;"><?php echo(lclCUSTOM_fetchC('eacontent')); ?></td>
						</tr>
						<tr>
							<td align="left" valign="top" style="width:900px;height:30px;padding-bottom:50px;"><?php include('../order/orderform.php'); ?></td>
						</tr>
					</table>
					<div id="innerfooter">
						<div id="footerlogo" align="left"><a href="/" title="Home Page"><img src="/images/logo-bigbanners-footer.jpg" alt="" width="167" height="27" border="0" /></a></div>
						<div id="innerfooternavigation" align="right"><?php include('footer.php'); ?></div>
					</div>
				</div>
			</div>
		</div>
